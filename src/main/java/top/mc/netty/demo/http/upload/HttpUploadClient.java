...
//        channel.closeFuture().sync();
    ...
    private static List<InterfaceHttpData> formpost(
        ...
        bodyRequestEncoder.addBodyAttribute("secondinfo", "secondvalue测试&");
        //文件操作类型
        bodyRequestEncoder.addBodyAttribute("optType","ADDFILE");
        bodyRequestEncoder.addBodyAttribute("fileUrl","tmp");
